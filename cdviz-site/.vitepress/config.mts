...
const COLLECTOR_VERSION = "0.50.0";
...
export default defineConfig({
  ...
  head: [
    ...
    [
      "script",
      {},
      // with a managed reverse proxy domain to posthog
      ...
      "/docs/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "CDviz vs Swarmia", link: "/docs/alternatives/vs-swarmia" },
          ],
        },
      ],
      "/pro/": [
