...
<template>
  <section class="my-8 sm:my-12 lg:my-16 bg-gradient-to-br from-background to-secondary/4 py-12 sm:py-16 px-4 sm:px-6 lg:px-8 rounded-2xl shadow-sm border border-secondary/10">
    <a id="faq"></a>
    <H2>Frequently Asked Questions</H2>
    <div class="max-w-3xl mx-auto">
      <template v-for="aq in $frontmatter.faq" :key="aq.q">
        <!-- Category Header -->
        <div v-if="aq.a === ''" class="mt-6 sm:mt-8 mb-4 first:mt-0">
        ...
        <!-- FAQ Item -->
        <details v-else class="interactive-element cursor-pointer transition-all duration-300 ease-out hover:shadow-lg bg-background/80 border border-secondary/20 my-3 sm:my-4 rounded-xl p-4 sm:p-6 shadow-sm touch-manipulation transform-gpu group">
